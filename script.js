...
const categorias = {
    Frutas: ["abacaxi", "manga", "pera", "tangerina", "melancia"],
    Profissoes: ["fotografo", "mecanico", "policial", "engenheiro", "bombeiro"],
    Animais: ["cachorro", "gato", "leao", "cavalo", "girafa"],
    Cidades: ["recife", "olinda", "caruaru", "paulista"],
};
...
function tentativa(letra) {
    if (palavraProposta.includes(letra)) {
        ...
        letrasErradas.innerHTML = "Letra errada:"  + letrasErradasArray;
